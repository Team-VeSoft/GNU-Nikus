...
#include <stdint.h>
#include <stdbool.h>
#include "Drivers/keyboard.h" // Подключаем заголовочный файл для драйвера клавиатуры
#include "Drivers/vga.h"      // Подключаем заголовочный файл для драйвера VGA
#include "commands.h" // Подключаем заголовочный файл для обработчиков команд
#include "Drivers/vfs.h"      // Подключаем заголовочный файл для виртуальной файловой системы
...
void _start(struct MemoryRegion* mem_regions, size_t mem_region_count) {
    ...
    const char* welcome_message = "Welcome to nikusOS!\nType 'help' for a list of commands.\n";
